...
describe "Merchants API" do
  ...
  it "sends the total revenue for specified date across all merchants" do
    customer_1 = create(:customer)
    merchant_1 = create(:merchant)
    merchant_2 = create(:merchant)
    merchant_3 = create(:merchant)
    ...
    invoice_3 = create(:invoice, customer_id: customer_1.id, merchant_id: merchant_3.id, updated_at: "2012-03-27 16:12:25 UTC", created_at: "2012-03-27 16:12:25 UTC")
    invoice_4 = create(:invoice, customer_id: customer_1.id, merchant_id: merchant_4.id, updated_at: "2012-03-27 16:12:25 UTC", created_at: "2012-03-27 16:12:25 UTC")
    invoice_5 = create(:invoice, customer_id: customer_1.id, merchant_id: merchant_4.id, updated_at: "2012-03-27 16:12:25 UTC", created_at: "2012-03-27 16:12:25 UTC")
    invoice_6 = create(:invoice, customer_id: customer_1.id, merchant_id: merchant_5.id, updated_at: "2012-03-27 16:12:25 UTC", created_at: "2012-03-27 16:12:25 UTC")
    ...
    item_3 = create(:item, unit_price: 32345, merchant_id: merchant_2.id, updated_at: "2012-03-27 16:12:25 UTC", created_at: "2012-03-27 16:12:25 UTC")
    item_4 = create(:item, unit_price: 42345, merchant_id: merchant_3.id, updated_at: "2012-03-27 16:12:25 UTC", created_at: "2012-03-27 16:12:25 UTC")
    item_5 = create(:item, unit_price: 52345, merchant_id: merchant_4.id, updated_at: "2012-03-27 16:12:25 UTC", created_at: "2012-03-27 16:12:25 UTC")
    item_6 = create(:item, unit_price: 62345, merchant_id: merchant_4.id, updated_at: "2012-03-27 16:12:25 UTC", created_at: "2012-03-27 16:12:25 UTC")
    ...
    create(:invoice_item, item_id: item_3.id, invoice_id: invoice_2.id, unit_price: item_3.unit_price, quantity: 15, updated_at: "2012-03-27 16:12:25 UTC", created_at: "2012-03-27 16:12:25 UTC")
    create(:invoice_item, item_id: item_4.id, invoice_id: invoice_3.id, unit_price: item_4.unit_price, quantity: 1, updated_at: "2012-03-27 16:12:25 UTC", created_at: "2012-03-27 16:12:25 UTC")
    create(:invoice_item, item_id: item_5.id, invoice_id: invoice_4.id, unit_price: item_5.unit_price, quantity: 1, updated_at: "2012-03-27 16:12:25 UTC", created_at: "2012-03-27 16:12:25 UTC")
    create(:invoice_item, item_id: item_6.id, invoice_id: invoice_5.id, unit_price: item_6.unit_price, quantity: 1, updated_at: "2012-03-27 16:12:25 UTC", created_at: "2012-03-27 16:12:25 UTC")
    ...
    get "/api/v1/merchants/revenue?date=2012-03-27 16:12:25 UTC"
  ...
  it "returns the customer who has conducted the most total number of successful transactions for a single merchant" do
    skip
    customer_1 = create(:customer, id: 1)
    customer_2 = create(:customer, id: 2)
    merchant_1 = create(:merchant)
    invoice_1 = create(:invoice, customer_id: customer_1.id, merchant_id: merchant_1.id, updated_at: "2012-03-27 16:12:25 UTC", created_at: "2012-03-27 16:12:25 UTC")
    invoice_2 = create(:invoice, customer_id: customer_2.id, merchant_id: merchant_1.id, updated_at: "2012-03-27 16:12:25 UTC", created_at: "2012-03-27 16:12:25 UTC")
    invoice_3 = create(:invoice, customer_id: customer_2.id, merchant_id: merchant_1.id, updated_at: "2012-03-27 16:12:25 UTC", created_at: "2012-03-27 16:12:25 UTC")
    invoice_4 = create(:invoice, customer_id: customer_1.id, merchant_id: merchant_1.id, updated_at: "2012-03-27 16:12:25 UTC", created_at: "2012-03-27 16:12:25 UTC")
    invoice_5 = create(:invoice, customer_id: customer_2.id, merchant_id: merchant_1.id, updated_at: "2012-03-27 16:12:25 UTC", created_at: "2012-03-27 16:12:25 UTC")
    invoice_6 = create(:invoice, customer_id: customer_2.id, merchant_id: merchant_1.id, updated_at: "2012-03-27 16:12:25 UTC", created_at: "2012-03-27 16:12:25 UTC")
    item_1 = create(:item, unit_price: 12345, merchant_id: merchant_1.id)
    item_2 = create(:item, unit_price: 22345, merchant_id: merchant_1.id)
    item_3 = create(:item, unit_price: 32345, merchant_id: merchant_1.id)
    item_4 = create(:item, unit_price: 42345, merchant_id: merchant_1.id)
    item_5 = create(:item, unit_price: 52345, merchant_id: merchant_1.id)
    item_6 = create(:item, unit_price: 62345, merchant_id: merchant_1.id)
    create(:invoice_item, item_id: item_1.id, invoice_id: invoice_6.id, unit_price: item_1.unit_price, quantity: 1)
    create(:invoice_item, item_id: item_2.id, invoice_id: invoice_1.id, unit_price: item_2.unit_price, quantity: 1)
    create(:invoice_item, item_id: item_3.id, invoice_id: invoice_2.id, unit_price: item_3.unit_price, quantity: 15)
    create(:invoice_item, item_id: item_4.id, invoice_id: invoice_3.id, unit_price: item_4.unit_price, quantity: 1)
    ...
    #expect(customer["data"]["attributes"]["revenue"]).to eq("689,345.00")
    #expect(merchants["data"][2]["id"]).to eq(merchant_3.id.to_s)
  end
end
