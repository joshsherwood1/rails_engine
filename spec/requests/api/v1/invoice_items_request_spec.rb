...
describe "Invoice Items API" do
  ...
  it "finds all invoice items record matches based on id" do
    customer_1 = create(:customer)
    merchant_1 = create(:merchant)
    merchant_2 = create(:merchant)
    merchant_3 = create(:merchant)
    ...
    expect(invoice_items["data"].all? { |hash| hash["attributes"]["id"] == 1 }).to eq(true)
  end

  it "finds all invoice items record matches based on invoice id" do
    customer_1 = create(:customer)
    merchant_1 = create(:merchant)
    merchant_2 = create(:merchant)
    merchant_3 = create(:merchant)
    ...
    expect(invoice_items["data"].count).to eq(1)
    expect(invoice_items["data"].all? { |hash| hash["attributes"]["invoice_id"] == 2 }).to eq(true)
  end

  it "finds all invoice items record matches based on item id" do
    customer_1 = create(:customer)
    merchant_1 = create(:merchant)
    merchant_2 = create(:merchant)
    merchant_3 = create(:merchant)
    ...
    expect(invoice_items["data"].count).to eq(1)
    expect(invoice_items["data"].all? { |hash| hash["attributes"]["item_id"] == 2 }).to eq(true)
  end

  it "finds all invoice items record matches based on unit price" do
    customer_1 = create(:customer)
    merchant_1 = create(:merchant)
    merchant_2 = create(:merchant)
    merchant_3 = create(:merchant)
    ...
    get "/api/v1/invoice_items/find_all?unit_price=52345"
  ...
  it "finds all invoice items record matches based on quantity" do
    ...
    expect(invoice_items["data"].all? { |hash| hash["attributes"]["quantity"] == 1 }).to eq(true)
  end

  it "finds all invoice items record matches based on updated_at" do
    customer_1 = create(:customer)
    merchant_1 = create(:merchant)
    merchant_2 = create(:merchant)
    merchant_3 = create(:merchant)
    ...
    expect(invoice_items["data"].count).to eq(5)
    expect(invoice_items["data"].all? { |hash| Time.parse(hash["attributes"]["updated_at"]) == "2012-03-27 14:53:59 UTC" }).to eq(true)
  end

  it "finds all invoice items record matches based on created_at" do
    customer_1 = create(:customer)
    merchant_1 = create(:merchant)
    merchant_2 = create(:merchant)
    merchant_3 = create(:merchant)
    ...
    get "/api/v1/invoice_items/find_all?created_at=2012-03-27 16:12:25 UTC"
